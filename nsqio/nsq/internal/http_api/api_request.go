...
// and parse out NSQ daemon's expected response format, with deadlines
funuc (c *Client) GETV1(endpoint string, v interface{}) error {
retry:
...
// PostV1 is helper function to perform a V1 HTTP request
// and parse our NSQ daemon's expected response format, with deadline.
