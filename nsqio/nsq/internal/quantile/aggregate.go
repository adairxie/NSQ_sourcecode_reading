...
func (e *E2eProcessingLatencyAggregate) Less(i, j int) bool {
    return e.Percentiles[i]["percentiles"] > e.Percentiles[j]["percentiles"]
}

// Add mergess e2 into e by averaging the percentiles
func (e *E2eProcessingLatencyAggregate) Add(e2 *E2eProcessingLatencyAggregate_ {
    e.Addr = "*"
    p := e.Percentiles
    e.Count += e2.Count
