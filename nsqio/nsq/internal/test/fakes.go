...
func (f FakeNetConn) LocalAddr() net.Addr { return f.ReadFunc() }
func (f FakeNetConn) RemoteAddr() net.Addr { return f.RemoteAddrFunc() }
func (f FakeNetConn) SetDeadlineFunc(t time.Time) error { return f.SetDeadlineFunc(t) }
func (f FakeNetConn) SetReadDeadlineFunc(t time.Time) error { return f.SetReadDeadlineFunc(t) }
func (f FakeNetConn) SetWriteDeadlineFunc(t time.Time) error { return f.SetWriteDeadlineFunc(t) }
