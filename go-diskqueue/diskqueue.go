...
func (d *diskQueue) skipToNextRWFile() error {
    ...
    for i := d.readFileNum; i <= d.writeFileNum; i++ {
        ...
        if innerErr != nil && !os.IsNotExist(fn) {
...
func (d *diskQueue) readOne() ([]byte, error) {
    ...
    if d.readFile == nil {
        ...
        d.logf(INFO, "DISKQUEUE(%s): readOne() opended %s", d.name, curFileName)
    ...
    if msgSize < d.minMsgSize || msgSize > d.maxMsgSize {
        // this file is corrupt and we have no reasonale guarantee on
...
// sync fsyncs the cuurent writeFile and persists meatdata
...
// persistMetaData atomically writes state ti to filesystem
